...
const PostsItem = ({ post }) => {
  ...
  return (
    <article className="overflow-hidden rounded-lg shadow transition hover:shadow-lg w-1/2 mt-5 m-auto">
      <img alt="Office" src={post.image} className="h-96 w-full object-cover" />
      ...
      <div className="bg-white p-4 sm:p-6">
        ...
        {isAdmin && (
          <>
            <button
              className="inline-block rounded border border-current px-8 py-3 text-sm font-medium text-indigo-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-indigo-500 m-3"
              onClick={() => {
